...
from motion.core import DistOptimizerHook
from motion.datasets import DATASETS, build_dataloader
from motion.solver.fastai_optim import OptimWrapper
from motion.torchie.trainer import DistSamplerSeedHook, Trainer, obj_from_dict
from motion.utils.print_utils import metric_to_str
from torch import nn
from torch.nn.parallel import DistributedDataParallel

from .env import get_root_logger

#python -m torch.distributed.launch --nproc_per_node=8 ./tools/train.py examples/centerpoint/configs/waymo_all_pp.py --work_dir ./experiments/ppcenter_sync_ped_down1-reg1-dbtr-1x
